...
const oddValues = (arr) => {
  // Solution code here...
  let newarr= arr.filter((element,ind)=>{
    if(element%2===1){
        return element;
    }
  });
...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
return arr.filter(val=>val.includes('a')||val.includes('u')||val.includes('o')||val.includes('i')||val.includes('e'));
};
