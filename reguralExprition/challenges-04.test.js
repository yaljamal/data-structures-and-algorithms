...
You want to teach a friend how to play hangman and 
want to show them using a partially complete puzzle.

Write a function named hangman which uses the replace method 
to remove all of the vowels (a, e, i, o, u) from the hangman string,
 regardless of capitalization, and replace them with an underscore.

The function should return a string containing the consonants
 in their original positions and underscores where the vowels were previously located.
...
let hangman = (str) => {
    // Solution code here...
    let r = new RegExp(/[aeiou]/ig);

    return str.replace(r, '_');
};
...
const findShells = (str) => {
    // Solution code here...
    let r = new RegExp(/[A-Za-z/]*ells/gm);
